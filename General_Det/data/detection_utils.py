...
# from lvis_coco1232_label_embedding import lvis_coco1232_label_embedding as lc1232

# LE = torch.tensor(lc1232)
...
Attention: 
    categoy_id -1
"""
def read_ann_from_text(label_path):
    record = []
    ...
    if os.path.exists(label_path):
        ...
        for line in lines:
            ...
            record.append({
                "category_id":int(items[0]-1),
                "bbox":items[1:],
                "bbox_mode": BoxMode.XYWH_ABS,
            })
    else:
        print(f'no label text, want:{label_path}')

...
# ************************
# Coppied form Detic/tools
# jsut run with no args
# ************************
...
NO_SEG = False
if NO_SEG:
    SAVE_PATH = 'datasets/lvis/lvis_v0.5_train+coco_box.json'
else:
    SAVE_PATH = 'datasets/lvis/lvis_v0.5_train+coco_mask.json'
THRESH = 0.7
DEBUG = False
...
if __name__ == '__main__':
    ...
    _ = lvis_data.pop('annotations')
    _ = lvis_data.pop('images')
    lvis_data['annotations'] = anns
    lvis_data['images'] = images

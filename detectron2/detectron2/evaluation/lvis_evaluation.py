    ...
    def _eval_box_proposals(self, predictions):
        ...
        for limit in [100, 1000]:
            for area, suffix in areas.items():
                ...
                # stats = _evaluate_box_proposals(predictions, self._lvis_api, thresholds=[0.3,0.4,0.5,0.6,0.7] ,area=area, limit=limit)
                # print('change threshold to 0.3,0.4,0.5,0.6,0.7')

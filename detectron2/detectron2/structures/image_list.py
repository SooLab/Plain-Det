...
class ImageList(object):
    ...
    def from_tensors(
        ...
        # max_hw = max(max_size[0], max_size[1])
        # if max_hw%14 != 0:
        #     max_hw = max_hw + (14 - max_hw%14)
        # max_size = [max_hw , max_hw]
        # H = max_size[0]%14
        # W = max_size[1]%14
        # if H != 0:
        #     max_size[0] = max_size[0]+(14 - H)
        # if W != 0:
        #     max_size[1] = max_size[1]+(14 - W)
        
        # print(f"max_size:{max_size}")
            
        # assert 1==3 ,f"max_size:{max_size}"

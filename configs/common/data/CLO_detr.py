...
dataloader.train = L(build_custom_train_loader)(
    dataset=L(get_detection_dataset_dicts_with_source)(
        dataset_names=["coco_2017_train","lvis_v1_train", "object365_train"],
        filter_empty=False,
        ),
    ...
    sampler=L(MultiDatasetSampler)(
        ...
        rfs = {
            ...
            "use_rfs":[True, False, False],# if calculate online
            "load_rfs":[False, True, True],# if load pre-calculated rfs
            "load_path":[None,RFS_PATH_l,RFS_PATH_o], # pre-calculated rfs paths
        },
        dataset_ann=["box", "box", "box"],

...
coco = 'label_embedding/coco_clip_a+name-none.npy'
lvis_v1 = 'label_embedding/lvis_clip_a+name-none.npy'
oid = 'label_embedding/oid601_clip_a+name-none.npy'
o365 = 'label_embedding/o365_clip_a+name-none.npy'
LE = [coco, lvis_v1, o365, oid]

model = L(DeformableDETR256)(
    output_dir = None,
    online_sample = False,
    label_embedding=LE,
    backbone=L(ResNet)(
